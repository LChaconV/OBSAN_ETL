...
oro_aluvion = IconScaleLayer(
    id          = "oro_aluvion",
    label       = "Explotación de Oro de Aluvión",
    description = "Hectáreas de explotación ilícita de oro de aluvión por municipio",
    data_table  = "v_alluvial_gold_illicit_pct",
    geo_table   = "dim_divipola",
    geo_id_col  = "id_mun",
    geo_geom_col= "geometry",
    muni_id_col = "id_mun",
    value_col   = "illicit_pct",
    value_label = "% explotación ilícita",
    value_unit  = "%",
    agg_func    = "AVG",
    year_col    = "year",
    icon        = "⛏️",
...
LAYER_TREE = LayerGroup(
    ...
    items = [
        ...
        LayerGroup(
            ...
            icon     = "⛽",
            expanded = False,
            items    = [produccion_petroleo, produccion_gas, regalias, regalias_minerales, oro_aluvion],
        ),
        LayerGroup(
            id       = "clima",
            label    = "Clima",
