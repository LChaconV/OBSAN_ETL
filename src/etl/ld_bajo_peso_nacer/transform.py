...
from src.etl.utils.sivigila_transform_utils import clear_raw, transform_manual, build_fact_table_golden, save_fact_golden_parquet
# ============================================================
# RUTAS
# ============================================================
def run() -> None:
    ...
    df, config,run_name = clear_raw("bajo_peso_nacer_transform", LOG_DIR, CONFIG_PATH)
    print(df.head())
    print(df.dtypes)
